#ifndef YUNDB_INCLUDE_YUNDB_FILTER_POLICY_H
#define YUNDB_INCLUDE_YUNDB_FILTER_POLICY_H
// Header guard standardized to YUNDB_INCLUDE_YUNDB_FILTER_POLICY_H
...
#endif // YUNDB_INCLUDE_YUNDB_FILTER_POLICY_H