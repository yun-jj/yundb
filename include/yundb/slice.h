#ifndef YUNDB_INCLUDE_YUNDB_SLICE_H
#define YUNDB_INCLUDE_YUNDB_SLICE_H
// Header guard standardized to YUNDB_INCLUDE_YUNDB_SLICE_H
...
#endif // YUNDB_INCLUDE_YUNDB_SLICE_H